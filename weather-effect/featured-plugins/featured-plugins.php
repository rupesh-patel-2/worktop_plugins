...
wp_enqueue_style( 'awplife-we-feature-plugins', WE_PLUGIN_PATH . 'featured-plugins/css/feature-plugins.css' );
?>
<style>
.col-md-12{
							...
							if ( current_user_can( 'install_plugins' ) || current_user_can( 'update_plugins' ) ) {
								...
								switch ( $status['status'] ) {
									...
									case 'newer_installed':
										$action_links[] = '<span class="button button-primary button-disabled" title="' . esc_attr__( 'This plugin is already installed and is up to date' ) . ' ">' . _x( 'Installed', 'plugin' ) . '</span>';
										break;
								}
							}
							?>
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12 text-center custom-buy-button">
											<a href="https://awplife.com/premium-wordpress-plugins/" target="_blank" class="button button-primary button-hero"><i class="glyphicon glyphicon-shopping-cart"></i> Get Premium Plugin</a>
										</div>
									</div>
									<hr>
								</div>
