<p class="frm_grid_container">
	<label class="frm4 frm_form_field frm_help" title="<?php esc_attr_e( 'The default message seen when after an entry is updated.', 'formidable-pro' ) ?>">
...
<p class="frm_grid_container">
	<label class="frm4 frm_form_field frm_help" title="<?php esc_attr_e( 'The label on the submit button when editing and entry.', 'formidable-pro' ) ?>">
...
<p class="frm_grid_container">
	<label class="frm4 frm_form_field frm_help" title="<?php esc_attr_e( 'The message seen when a user who is not logged-in views a form only logged-in users can submit.', 'formidable-pro' ); ?>">
...
<p class="frm_grid_container">
	<label class="frm4 frm_form_field frm_help" title="<?php esc_attr_e( 'The message seen when a user attempts to submit a form for a second time if submissions are limited.', 'formidable-pro' ) ?>">
